...
import { tutorialStepsEn } from "./tutorial/steps.en";
import { tutorialStepsNl } from "./tutorial/steps.nl";
...
export const TutorialDialog = () => {
    ...
    const tutorialSteps =
        $language === "nl" ? tutorialStepsNl : tutorialStepsEn;
                    ...
                    <div className="flex flex-col gap-y-2 justify-between items-center pt-4">
                        <div className="flex items-center space-x-2">
                            <Button
                                ...
                                className="text-sm"
                            >
                                {t("tutorialDialog.skip")}
                            </Button>
                            <div className="hidden md:block text-xs text-muted-foreground">
                                {t("tutorialDialog.useArrowKeys")}
                            </div>
                            <div className="text-sm text-muted-foreground">
                                {t("tutorialDialog.progress", {
                        ...
                        <div className="flex items-center space-x-2">
                            ...
                            >
                                ...
                                <span>{t("tutorialDialog.previous")}</span>
                            </Button>
                            {$tutorialStep === tutorialSteps.length - 1 ? (
                                ...
                                <Button
                                    ...
                                    className="flex items-center space-x-1"
                                >
                                    <span>{t("tutorialDialog.next")}</span>
